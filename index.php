...
class Index extends CommonObjects
{
    ...
    private function populateRoutesAuth(): void
    {
        $this->routes = [
            ...
            '/crystal-market/:string' => 'CrystalMarketHandler',
            '/crystal-market/:string/:number' => 'CrystalMarketHandler',
            '/events' => 'EventsHandler',
            '/events/:string' => 'EventsHandler',
            '/events/:string/:number' => 'EventsHandler',
            '/gangs' => 'GangHandler',
            '/gangs/:string' => 'GangHandler',
            '/gangs/:string/:number' => 'GangHandler',
